...
void GlfwWindowResizeddCallBack(GLFWwindow* window, int width, int height)
{
...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Carrillo Joseph - 100746949", nullptr, nullptr);
	glfwMakeContextCurrent(window);

	//Set our window resized callback
	glfwSetWindowSizeCallback(window, GlfwWindowResizeddCallBack);
